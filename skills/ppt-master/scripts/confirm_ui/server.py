...
_PPT_MASTER_HOME = Path(os.getenv('PPT_MASTER_HOME', str(_SKILL_DIR))).expanduser()
_CATALOGS_PATH = Path(__file__).resolve().parent / 'static' / 'catalogs.json'
_ICON_LIBRARY_DIR = _PPT_MASTER_HOME / 'templates' / 'icons'
_AI_IMAGE_COMPARISON_DIR = _PPT_MASTER_HOME / 'references' / 'ai-image-comparison'
