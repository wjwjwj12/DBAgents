...
_LOCAL_SKILL_DIR = Path(__file__).resolve().parent.parent
_PPT_MASTER_HOME = Path(os.getenv("PPT_MASTER_HOME", str(_LOCAL_SKILL_DIR))).expanduser()
_GLOBAL_SOUNDS_DIR = _PPT_MASTER_HOME / "templates" / "sounds"
